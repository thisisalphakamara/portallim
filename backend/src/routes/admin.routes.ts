...
import { createStaffAccount, getAllStaff, getSystemStats, getAuditLogs, runSystemBackup, clearSystemCache, exportAuditLogs, deleteStaffAccount } from '../controllers/admin.controller';
...
router.delete('/staff/:email', authenticateToken, authorizeRoles(Role.SYSTEM_ADMIN), deleteStaffAccount);
